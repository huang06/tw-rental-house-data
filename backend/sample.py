...
from rental.enums import DealStatusType  # noqa: E402
from rental.models import House, HouseTS, Vendor  # noqa: E402

vendor = Vendor.objects.get(pk=1)

basic_deal = 'basic_deal_4d'
basic_ts = {'year': 2018, 'month': 8, 'vendor': vendor, 'vendor_house_id': basic_deal}
...
id = 'douple_deal_2d'
ts_param = {'year': 2018, 'month': 8, 'vendor': vendor, 'vendor_house_id': id}
